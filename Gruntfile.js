    ...
    concat: {
      ...
      build: {
        src: ['js/superformula.js', 'src/start.js', 'src/vars.js', 'src/star_constructor.js', 'src/wrangler.js', 
              ...
              'src/visualizations/barchart.js', 'src/visualizations/linechart.js', 'src/start_selection.js', 'src/visualizations/table.js', 
              ...
              'src/visualizations/piechart.js', 'src/visualizations/stacked.js', 
